...
enum CodexTranscriptParser {
    static func loadHistory(sessionId: String) async -> [ChatHistoryItem] {
    ...
    private static func parseTranscript(at url: URL, sessionId: String) -> [ChatHistoryItem] {
    ...
    private static func extractMessageText(from rawContent: Any?) -> String {
    ...
    private static func parseToolInput(payload: [String: Any]) -> [String: String] {
    ...
    private static func flattenTopLevelDictionary(_ dictionary: [String: Any]) -> [String: String] {
    ...
    private static func normalizeToolOutput(_ output: String?) -> String? {
    ...
    private static func parseTimestamp(_ raw: String?) -> Date {
        ...
        if let date = ISO8601DateFormatter.basicInternet.date(from: raw) {
            return date
        }
        return Date()
    }
...
private extension ISO8601DateFormatter {
    ...
    static let basicInternet: ISO8601DateFormatter = {
        let formatter = ISO8601DateFormatter()
